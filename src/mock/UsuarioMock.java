...
public class UsuarioMock {
    ...
    private UsuarioMock() {
        Usuario juan = new Docente("Juan Pablo Sanchez", "13456789-5", 'M', "Ing. Informatica", "Arquitecto de Software", "Magister");
        juan.setPrestamo("978-9876543210");
        usuarios.add(juan);
        usuarios.add(new Docente("Maria del Pilar Ramirez", "17892345-K", 'M', "Medico", "Medico Cirujano", "Doctorado"));
        Usuario juanEstudiante = new Estudiante("Juan Pablo Sanchez", "22345678-2", 'M', "Ing. Informatica", "Arquitectura");
        juanEstudiante.setPrestamo("978-0140449136");
        usuarios.add(juanEstudiante);
